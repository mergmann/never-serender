...
namespace NeverSerender.UserInterface.Tools
{
    public static class UiTools
    {
        ...
        private static readonly Regex RxHexColorRgbRegex =
            new Regex("([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})", RegexOptions.IgnoreCase);

        private static readonly Regex RxHexColorRgbaRegex =
            new Regex("([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})", RegexOptions.IgnoreCase);
        ...
        public static string GetLabelOrDefault(string name, string label = null)
        {
            ...
            for (var i = 1; i < words.Length; i++) words[i] = words[i].ToLower();
